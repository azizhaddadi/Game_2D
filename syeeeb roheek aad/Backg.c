...
{
    Backgf->img= IMG_Load("Backgf.png");
    if (Backgf->img == NULL)
    {
        printf("Unable to load bitmap: %s\n", SDL_GetError());
        return;
    ...
    while(!done)
    {
        while((GTS==0)&&(!done))
        {
            ...
            if(f==0)
            {
                ...
                afficherButton(Copyrights,screen);
                if(A==1)afficherButton(ButtonAA,screen);
                else afficherButton(ButtonA,screen);
                if(B==1)afficherButton(ButtonBB,screen);
                else afficherButton(ButtonB,screen);
                if(C==1)afficherButton(ButtonCC,screen);
                else afficherButton(ButtonC,screen);
            ...
            if(f==1)
            {
                ...
                afficherButton(Copyrightsf,screen);
                if(Af==1)afficherButton(ButtonAAf,screen);
                else afficherButton(ButtonAf,screen);
                if(Bf==1)afficherButton(ButtonBBf,screen);
                else afficherButton(ButtonBf,screen);
                if(Cf==1)afficherButton(ButtonCCf,screen);
                else afficherButton(ButtonCf,screen);
            ...
            if(SDL_PollEvent(&event));
            {
                ...
                case SDL_MOUSEBUTTONDOWN:
                {
                    ...
                    //Click sur Start
                    if((f==0)&&(event.button.button==SDL_BUTTON_LEFT)&&(event.button.x>=60)&&(event.button.x<=320)&&(event.button.y>=200)&&(event.button.y<=262)&&(click==0))
                    {
                        Click= Mix_LoadWAV("Click.wav");
                        Mix_PlayChannel(-1,Click,0);
                        done=1;
                    ...
                    //Click sur Settings
                    if((f==0)&&(event.button.button==SDL_BUTTON_LEFT)&&(event.button.x>=60)&&(event.button.x<=320)&&(event.button.y>=270)&&(event.button.y<=332))
                    {
                        if(click==0)
                        {
                            Click= Mix_LoadWAV("Click.wav");
                    ...
                    //Click sur Quit
                    if((f==0)&&(event.button.button==SDL_BUTTON_LEFT)&&(event.button.x>=60)&&(event.button.x<=320)&&(event.button.y>=340)&&(event.button.y<=402))
                    {
                        if(click==0)
                        {
                            Click= Mix_LoadWAV("Click.wav");
                    ...
                    if((f==1)&&(event.button.button==SDL_BUTTON_LEFT)&&(event.button.x>=400)&&(event.button.x<=600)&&(event.button.y>=400)&&(event.button.y<=600)&&(click==0))
                    {
                        Click= Mix_LoadWAV("Click.wav");
                        Mix_PlayChannel(-1,Click,0);
                    }
                    //Click sur Settings fullscreen
                    if((f==1)&&(event.button.button==SDL_BUTTON_LEFT)&&(event.button.x>=800)&&(event.button.x<=1000)&&(event.button.y>=400)&&(event.button.y<=600))
                    {
                        if(click==0)
                        {
                            Click= Mix_LoadWAV("Click.wav");
                    ...
                    if((f==1)&&(event.button.button==SDL_BUTTON_LEFT)&&(event.button.x>=1200)&&(event.button.x<=1400)&&(event.button.y>=400)&&(event.button.y<=600))
                    {
                        if(click==0)
                        {
                            Click= Mix_LoadWAV("Click.wav");
                ...
                {
                    //Curseur sur Play
                    if((f==0)&&(event.motion.x>=60)&&(event.motion.x<=320)&&(event.motion.y>=200)&&(event.motion.y<=262))
                        A=1;
                    else A=0;


                    //Curseur sur Settings
                    if((f==0)&&(event.motion.x>=60)&&(event.motion.x<=320)&&(event.motion.y>=270)&&(event.motion.y<=332))
                        B=1;
                    else B=0;

                    //Curseur sur Quit
                    if((f==0)&&(event.button.x>=60)&&(event.button.x<=320)&&(event.button.y>=340)&&(event.button.y<=402))
                        C=1;
                    else C=0;
                    //Curseur sur Play Fullscreen
                    if((f==1)&&(event.button.x>=400)&&(event.button.x<=600)&&(event.button.y>=400)&&(event.button.y<=600))
                        Af=1;
                    else Af=0;


                    //Curseur sur Settings Fullscreen
                    if((f==1)&&(event.button.x>=800)&&(event.button.x<=1000)&&(event.button.y>=400)&&(event.button.y<=600))
                        Bf=1;
                    else Bf=0;

                    //Curseur sur Quit Fullscreen
                    if((f==1)&&(event.button.x>=1200)&&(event.button.x<=1400)&&(event.button.y>=400)&&(event.button.y<=600))
                        Cf=1;
                    else Cf=0;
        ...
        while((GTS==1))
        {
            ...
            if(f==0)
            {
                ...
                if(F==1)afficherButton(ButtonFF,screen);
                else afficherButton(ButtonF,screen);//button back
                if(H==1)afficherButton(ButtonHH,screen);
                else afficherButton(ButtonH,screen);//button-
                ...
                if(J==1)afficherButton(ButtonJJ,screen);
                else afficherButton(ButtonJ,screen);//button+
                if(K==1)afficherButton(ButtonKK,screen);
                else afficherButton(ButtonK,screen);//button full screen
                if(L==1)afficherButton(ButtonLL,screen);
                else afficherButton(ButtonL,screen);//button window screen
            ...
            if(f==1)
            {
                ...
                if(Ff==1)afficherButton(ButtonFFf,screen);
                else afficherButton(ButtonFf,screen);//button back
                if(Hf==1)afficherButton(ButtonHHf,screen);
                else afficherButton(ButtonHf,screen);//button-
                ...
                if(Jf==1)afficherButton(ButtonJJf,screen);
                else afficherButton(ButtonJf,screen);//button+
                if(Kf==1)afficherButton(ButtonKKf,screen);
                else afficherButton(ButtonKf,screen);//button full screen
                if(Lf==1)afficherButton(ButtonLLf,screen);
                else afficherButton(ButtonLf,screen);//button window screen
            ...
            if( SDL_PollEvent(&event))
            {
                ...
                case SDL_MOUSEBUTTONDOWN:
                {
                    ...
                    //click sur -
                    if((f==0)&&(event.button.button==SDL_BUTTON_LEFT)&&(event.button.x>=250)&&(event.button.x<=315)&&(event.button.y>=200)&&(event.button.y<=248))
                    {
                        if (click==0)
                        {
                            Click= Mix_LoadWAV("Click.wav");
                    ...
                    //click sur +
                    if((f==0)&&(event.button.button==SDL_BUTTON_LEFT)&&(event.button.x>=510)&&(event.button.x<=575)&&(event.button.y>=200)&&(event.button.y<=248))
                    {
                        if (click==0)
                        {
                            Click= Mix_LoadWAV("Click.wav");
                ...
                {
                    //Curseur sur -
                    if((f==0)&&(event.motion.x>=250)&&(event.motion.x<=315)&&(event.motion.y>=200)&&(event.motion.y<=248))
                        H=1;
                    else H=0;


                    //Curseur sur +
                    if((f==0)&&(event.motion.x>=510)&&(event.motion.x<=575)&&(event.motion.y>=200)&&(event.motion.y<=248))
                        J=1;
                    else J=0;
